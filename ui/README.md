...
* Text field for a URL (e.g., YouTube, cloud storage)
...
* Confidence score or similarity percentage
* Thumbnail image
* Short description
...
* Upload component
* Result card component (image, text, buttons)
* Audio player component
* Footer with attribution and privacy info
